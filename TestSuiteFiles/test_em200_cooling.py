...
class TestCoolingValveModule(unittest.TestCase):
    def setUp(self):
        ...
        self.plc.set_tag("FB200_EM_Cooling.UDT.Fault_Delay_Sec", 5.0)
        self.plc.set_tag("FB200_EM_Cooling.UDT.Fault_Tolerance_Perc", 5.0)
    ...
    def run_cooling_logic(self, current_time):
        ...
        valve_fdbk = self.plc.get_tag("FB200_EM_Cooling.UDT.CHW_Valve_Fdbk_AI")
        ...
        valve_failure_alm = self.plc.get_tag("FB200_EM_Cooling.UDT.Valve_Failure_Alm")
    ...
    def test_valve_failure_alarm(self):
        ...
        self.plc.set_tag("FB200_EM_Cooling.UDT.CHW_Valve_Fdbk_AI", 20.0)
        ...
        while current_time < 4.9:
            self.run_cooling_logic(current_time=current_time)
        ...
        self.run_cooling_logic(current_time=5.0)
