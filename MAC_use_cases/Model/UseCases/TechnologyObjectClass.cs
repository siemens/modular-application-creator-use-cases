...
namespace MAC_use_cases.Model.UseCases
{
    ...
    public class TechnologyObjectClass
    {
        ...
        /// <summary>
        ///     Creates a new object of the class, sets the MainTelegramNumber of the TechnologyObject add it to
        ///     myModule.ProvidedTechnologicalObjects
        /// </summary>
        /// <param name="myModule">The module</param>
        public TechnologyObjectClass(MAC_use_casesEM myModule)
        {
        ...
        public static void CreateTOs(PlcDevice plcDevice, MAC_use_casesEM module)
        {
        ...
        /// <summary>
        ///     This function configures the TechnologyObject (toInfo objects) and add it to the
        ///     myModule.ProvidedTechnologicalObjects
        ...
        public void ConfigureTO(TechnologicalObjectInfo TechnologicalObject, MAC_use_casesEM myModule)
        {
            //Add the additional parameters to the TechnologicalObjectInfo Object
            var toPath = "DynamicLimits.MaxVelocity";
