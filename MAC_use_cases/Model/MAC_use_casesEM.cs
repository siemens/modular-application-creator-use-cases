        ...
        public override bool GenerateTiaPortal(TiaTemplateContext tiaTemplateContext, string generationPhaseName)
        {
            ...
            switch (generationPhaseName)
            {
                ...
                case TiaGenerationPhases.Build:
                    ...
                    GenericBlockCreation.CreateFB($"{NameOfMyFb}_FBD", "CreatedDbFromMasterCopy",
                        ProgrammingLanguage.FBD,
                        m_plcDevice);
                    GenericBlockCreation.CreateFB($"{NameOfMyFb}_LAD", "CreatedDbFromMasterCopy",
                        ProgrammingLanguage.LAD,
                        m_plcDevice);
                    GenericBlockCreation.CreateFB($"{NameOfMyFb}_SCL", "CreatedDbFromMasterCopy",
