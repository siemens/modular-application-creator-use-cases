...
namespace MAC_use_cases.Model
{
    public abstract partial class BaseMAC_use_casesEM : TiaEquipmentModule, ITiaAttributeUser
    {
        ...
        protected BaseMAC_use_casesEM()
        {
            // Add language resources
            string resourceName = typeof(BaseMAC_use_casesEM).Assembly.ManifestModule.Name;
        ...
        protected string GetContentAdditionalResource(string name)
        {
            ...
            string returnString =
                new StreamReader(asm.GetManifestResourceStream("MAC_use_cases.TiaImports.AdditionalResources." + name))
                    .ReadToEnd();
