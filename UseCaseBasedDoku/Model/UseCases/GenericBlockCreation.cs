...
namespace UseCaseBasedDoku.Model.UseCases
{
    ...
    public class GenericBlockCreation
    {
        ...
        public static void GenerateDB(string dbName, PlcDevice plcDevice, UseCaseBasedDokuEM module)
        {
        ...
        public static void SetDefaultValue(string dbName, string parameterName, TIATYPE dataType, string value, UseCaseBasedDokuEM parent)
        {
        ...
        public static void GenerateMultiInstanceFB(PlcDevice plcDevice, TiaTemplateContext tiaTemplateContext, UseCaseBasedDokuEM module)
        {
            var MyFB = new XmlFB("MyMultiInstanceFB");
            MyFB.BlockAttributes.ProgrammingLanguage = ProgrammingLanguage.LAD;

            MultiInstanceCall myMultiInstanceFBCall = new MultiInstanceCall("MyMultiInstanceDbName", "UseCaseBasedDokuFB", plcDevice)
            {
                ["Input1"] = "1", // inputVariable1
                ["Input2"] = "0", // inputVariable1
                //["Input2"] = "inputVariable1", 
            ...
            customParam = new InterfaceParameter("MyMultiInstanceDbName", "\"" + "UseCaseBasedDokuFB" + "\"") { Remanence = RemanenceSettings.IgnoreRemanence };
        ...
        /// <param name="tiaTemplateContext">The tiaTemplateContext</param>
        /// <param name="plcDevice">The plcDevice</param>
        public static void GenerateOB_Main(string instanceDbName, UseCaseBasedDokuEM module, TiaTemplateContext tiaTemplateContext, PlcDevice plcDevice)
        {
        ...
        public static void GenerateMainOBWithMultipleCalls(string name, int numberOfCalls, TiaTemplateContext tiaTemplateContext, PlcDevice plcDevice, UseCaseBasedDokuEM Module)
        {
            ...
            {
                IntegrateLibraries.CreateInstanceDB(Module, Module.ResourceManagement.UseCaseBasedDokuFB, "CreatedDbFromMasterCopy" + i.ToString(), Module.ResourceManagement.ModuleBlocksRootGroup);
                ...
                myObBlockNetwork.GenerationLabel = new GenerationLabel(blockname, "Generated by MAC", Module.ModuleID.ToString());
