...
namespace UseCaseBasedDoku.Model.UseCases
{
    ...
    public class NonTIAProjectBased
    {
        ...
        /// <summary>
        /// Creates a new object of the class, create a new object of ModelToSerialize and add it to the ModelList. Start the method CopyModel()
        /// </summary>
        ...
        /// <summary>
        /// This function gets the first element of the ModelList. Serialize the object, deserialize an object of the specific type and add it to ModelList
        ...
        public void CopyModel()
        {
            ...
            var copyOfChannel = JsonConvert.DeserializeObject<ModelToSerialize>(jsonOfChannel, new JsonSerializerSettings());
    ...
    {
        /// <summary>
        /// [JsonProperty] means that this attribute will be serialized with its value to get the value again after serialization.
        ...
        /// </summary>
        /// <param name="name">The name of the model</param>
        public ModelToSerialize(string name)
        {
            Name = name;
        }
