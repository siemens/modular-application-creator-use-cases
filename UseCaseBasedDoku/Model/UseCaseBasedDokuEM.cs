...
using UseCaseBasedDoku.Model.UseCases;
...
namespace UseCaseBasedDoku.Model
{
    ...
    public class UseCaseBasedDokuEM : BaseUseCaseBasedDokuEM
    {
        ...
        [JsonIgnore]
        public string NameAndType => NamingConventions.CreateModuleNameAndTypeForEM("UseCaseBasedDoku", this);
        ...
        // </auto-generated>
        [JsonConstructor]
        public UseCaseBasedDokuEM(JsonConstructorMarker nullObj)
        {
        ...
        public override bool GenerateTiaPortal(TiaTemplateContext tiaTemplateContext, string generationPhaseName)
        {
            ...
            switch (generationPhaseName)
            {
                ...
                case TiaGenerationPhases.Build:
                    ...
                    IntegrateLibraries.CreateInstanceDB(this, this.ResourceManagement.UseCaseBasedDokuFB, "CreatedDbFromMasterCopy", this.ResourceManagement.ModuleBlocksRootGroup);
